...
function preload() {
    songP1 = loadSound("assets/songP1.mp3"); //by The Beatles'
    songP2 = loadSound("assets/songP2.mp3"); //by The Beatles'
    songP3 = loadSound("assets/songP3.mp3"); //by The Beatles'
    songP4 = loadSound("assets/songP4.mp3"); //by The Beatles'
    songP5 = loadSound("assets/songP5.mp3"); //by The Beatles'
    songInstru = loadSound("assets/songP6_instru.mp3"); //by The Beatles'
    songP7 = loadSound("assets/songP7.mp3"); //by The Beatles'
    songP8 = loadSound("assets/songP8.mp3"); //by The Beatles'
    ...
    //frameFour assets
    babyBBchirp = loadSound("assets/babyBBchirp.mp3"); //from biblesound.com
    landscape3 = loadImage("assets/landscape3.png");
    babyBB = loadImage("assets/babyBB.png");

    //frameFive assets
    landscape4 = loadImage("assets/landscape4.png");
    scaredBabyBB = loadSound("assets/scaredBabyBB.wav"); //from biblesound.com
